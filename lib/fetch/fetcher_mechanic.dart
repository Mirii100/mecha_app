...
class _NearbyMechanicsScreenState extends State<NearbyMechanicsScreen> {
  // Correct usage of GeoFlutterFirePlus
  ...
  Future<void> fetchNearbyMechanics(double latitude, double longitude) async {
    ...
    // Create a stream to listen for nearby mechanics using the correct methods
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final mechanicData = nearbyMechanics[index].data() as Map<String, dynamic>?; // Ensure the type is Map<String, dynamic>
